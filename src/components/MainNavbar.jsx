...
const MainNavbar = ({ handleShowModal }) => {
  ...
  <Container fluid>
    ...
    <Navbar.Brand className='pe-4 text-light' as={Link} to="/">
    ...
    <Navbar.Collapse id="responsive-navbar-nav">
      ...
      <Nav>
        ...
        <div className="d-none d-lg-flex">
          ...
          <Button className="m-2 rounded-pill" variant="outline-light" onClick={() => scrollToSection('AboutUs')}>Nosotros</Button>
        ...
        <div className="d-lg-none">
          <Dropdown>
            ...
            <Dropdown.Menu>
              <NavDropdown.Item onClick={() => scrollToSection('AboutUs')}>Nosotros</NavDropdown.Item>
        ...
        <Button className="m-2 rounded-pill" variant="outline-warning" onClick={handleShowModal}>Iniciar sesión</Button>
      </Nav>
    </Navbar.Collapse>
  </Container>
</Navbar>
